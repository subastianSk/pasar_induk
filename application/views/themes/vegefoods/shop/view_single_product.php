...
<hr>
  ...
  <!--<section class="ftco-section">-->
      ...
      <div class="container">
        <p class="breadcrumbs"><span class="mr-2"><?php echo anchor(base_url(), 'Home'); ?> ></span><span class="mr-2"><?php echo anchor(site_url('pages/category'), 'Belanja'); ?></span>> <span>Produk Detail</span></p>
        <hr>
          <div class="row">
            ...
            <p><a href="#" class="btn btn-black btn-sm py-3 px-5 add-cart cart-btn" data-sku="<?php echo $product->sku; ?>" data-name="<?php echo $product->name; ?>" data-price="<?php echo ($product->current_discount > 0) ? ($product->price - $product->current_discount) : $product->price; ?>" data-id="<?php echo $product->id; ?>">Beli Produk</a></p>
              </div>
          </div>
      </div>
  <!--</section>-->

  <section class="ftco-section d-none d-lg-block">
      <div class="container">
              <div class="row justify-content-center mb-3 pb-3">
        <div class="col-md-12 heading-section text-center ftco-animate">
            <span class="subheading">Produk Lain</span><hr>
