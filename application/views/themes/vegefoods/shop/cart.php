          ...
          <div class="row justify-content-end">
           <!-- <div class="col-lg-4 mt-5 cart-wrap ftco-animate">
              ...
              <div class="col-lg-4 mt-5 cart-wrap ftco-animate">
                  <div class="cart-total mb-3">
                      <h3>Kode Kupon</h3>
                      <p>Dapatkan potongan harga menarik</p>
              ...
              <div class="col-lg-4 mt-5 cart-wrap ftco-animate">
                  ...
                  <p><button type="submit" class="btn btn-primary py-3 px-4">Proses Pesanan</button></p>
              </div>
          </div>
          </form>
          <?php else : ?>
            <div class="row">
              <div class="col-md-12 ftco-animate">
                <div class="alert alert-info">Tidak ada barang dalam keranjang.<br><?php echo anchor('pages/belanja', 'Jelajahi produk kami'); ?> dan mulailah berbelanja!</div>
              </div>
            </div>
          <?php endif; ?>
          </div>
