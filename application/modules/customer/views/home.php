        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            ...
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>">Pasar</a></li>
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-lg-3 col-6">
            <a class="nav-link logout btn btn-danger btn-sm text-white font-weight-bold" href="<?php echo site_url('auth/logout'); ?>">Keluar</a>
         </div>
