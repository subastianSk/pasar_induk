...
<script>
  $(document).ready(function() {
    ...
    $(document).on('click', '.btnEdit', function() {
      ...
      $.ajax({
        method: 'GET',
        url: '<?php echo site_url('customer/home_api?action=view_data'); ?>',
        data: {id: id},
    ...
    $('#editCouponForm').submit(function(e) {
      ...
      $.ajax({
        method: 'POST',
        url: '<?php echo site_url('customer/home_api?action=edit_coupon'); ?>',
        data: data,
        success: function (res) {
          if (res.code == 201) {
    ...
    $('#deleteCoupon').submit(function(e) {
      ...
      $.ajax({
        method: 'POST',
        url: '<?php echo site_url('customer/home_api?action=delete_coupon'); ?>',
        data: {
            id: id
        },
        success: function (res) {
    ...
    var table = $('#packageList').DataTable({
      "ajax" : "<?php echo site_url('customer/home_api?action=coupon_list'); ?>",
      "columns" : [
        {"data": "id"},
        {"data": "name"},
        {"data": "code"},
    ...
    $('#addCouponForm').submit(function(e) {
      ...
      $.ajax({
        method: 'POST',
        url: '<?php echo site_url('customer/home_api?action=add_coupon'); ?>',
        data: data,
        context: this,
        success: function(res) {
          if (res.data) {
