...
class Pages extends CI_Controller {
    ...
    public function about()
    {
        ...
        $load_params['title'] = 'Tentang Kami';
        get_header($load_params);
    ...
    {   
        ...
        $products['products'] = $this->product->get_belanja();
       

        get_header($params);
        get_template_part('pages/belanja', $products);
        get_footer();
    }
